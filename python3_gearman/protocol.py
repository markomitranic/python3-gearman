...
def submit_cmd_for_background_priority(background, priority, scheduled = False):
    cmd_type_lookup = {
        ...
        (True, PRIORITY_HIGH, True): GEARMAN_COMMAND_SUBMIT_JOB_EPOCH,
        (True, PRIORITY_LOW, True): GEARMAN_COMMAND_SUBMIT_JOB_EPOCH
    }
    lookup_tuple = (background, priority, scheduled)
